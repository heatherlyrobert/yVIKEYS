...
static tMODE_INFO  s_modes [MAX_MODES] = {
   ...
   { SMOD_REGISTER, 's', 'y', "reg", "register"  , 1, ""                    , "5f--- p i ----- n 1---- r 0M-------- d o", "----- - - ----- - ----- - ---------- - -", "selecting specific registers for data movement"     , "regs=\"a-zA-Z-+0  pull=yYxXdD  -/+=vVcCtTsSfF  push=pPrRmMaAiIoObB  mtce=#?!g"           ,    0 },
   ...
   { SMOD_SRC_UNDO, 's', 'y', "sun", "src-undo"  , 2, ""                    , "5---- p i ----- n ----- r 0--------- d o", "----- - - ----- - ----- - ---------- - -", "source level undo and redo"                         , ""                                                                                        ,    0 },
