...
static tMODE_INFO  s_modes [MAX_MODES] = {
   ...
   { SMOD_TEXTREG , 's', 'y', "trg", "text reg"  , 2, ""                    , "5f:-- p i ----- n ----- r 0--------- d o", "----- - - ----- - ----- - ---------- - -", "selecting specific registers for text movement"     , "regs=\"a-zA-Z-+0  pull=yYxXdD  -/+=vVcCtTsSfF  push=pPrRmMaAiIoObB  mtce=#?!g"           ,    0 },
